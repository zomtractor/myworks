...
class Uformer(nn.Module):
    def __init__(self, img_size=256, in_chans=3, dd_in=3,
                 embed_dim=32, depths=[2, 2, 2, 2, 2, 2, 2, 2, 2], num_heads=[1, 2, 8, 16, 8, 4, 2],
        ...
        # mask decoder
        self.mask_decoderlayer1 = DWTBasicUformerLayer(dim=embed_dim * 2,
                                                input_resolution=(img_size,
                                                                  img_size),
                                                depth=1,
                                                num_heads=1,
                                                ...
                                                norm_layer=norm_layer,
                                                use_checkpoint=use_checkpoint)
        self.mask_decoderlayer2 = DWTBasicUformerLayer(dim=embed_dim * 2,
                                                input_resolution=(img_size,
                                                                  img_size),
                                                depth=1,
                                                num_heads=1,
        ...
        self.mask_guide1 = MaskAttentionUformerLayer(dim=embed_dim * 2,
                                                input_resolution=(img_size,
                                                                  img_size),
                                                depth=1,
                                                num_heads=1,
                                                ...
                                                norm_layer=norm_layer,
                                                use_checkpoint=use_checkpoint)
        self.mask_guide2 = MaskAttentionUformerLayer(dim=embed_dim * 2,
                                                input_resolution=(img_size,
                                                                  img_size),
                                                depth=1,
                                                num_heads=1,
    ...
    def forward(self, x):
        ...
        ##
        m_feature1 = self.mask_decoderlayer1(deconv2)
        y_feature1, m1 = self.mask_guide1(deconv2, m_feature1)

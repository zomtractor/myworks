...
from Models.model0201_ab06 import Uformer
...
# load yaml
with open(file="../configs/config0201_ab06.yaml", mode="r") as config:
...
for epoch in range(start_epoch, OPT['EPOCHS'] + 1):
    ...
    if epoch % TRAIN['VAL_AFTER_EVERY'] == 0:
        ...
        if psnr_val_rgb > 27.80:
            name = "model_psnr_"+str(psnr_val_rgb)+".pth"
            torch.save({'epoch': epoch,
                        'state_dict': model_base.state_dict(),
                        'optimizer': optimizer.state_dict()},

...
from Models.model0201 import Uformer
...
# load yaml
with open(file="../configs/config0201.yaml", mode="r") as config:
...
model_base = Uformer(img_size=256, embed_dim=16, win_size=8, token_mlp='leff',
                     depths=[1, 2, 8, 8, 4, 8, 8, 2, 1], dd_in=3, batch_size=OPT['BATCH']) #model13

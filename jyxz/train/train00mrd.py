...
from Models.model00MRDNet import build_net
...
# load yaml
with open(file="../configs/config00mrd.yaml", mode="r") as config:
...
for epoch in range(start_epoch, OPT['EPOCHS'] + 1):
    ...
    for i, data in enumerate(train_loader, 0):
        ...
        bottom, mid, restored = model_base(input_)
        name = data[3]

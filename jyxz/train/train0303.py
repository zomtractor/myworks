...
from Models.model0303 import MNet
#改model和config
...
# load yaml
with open(file="../configs/config0303.yaml", mode="r") as config:
...
# load model
model_base = MNet(dim=32, num_blocks=[1, 1, 1, 8])

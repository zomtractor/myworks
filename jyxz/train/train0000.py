...
from Models.NerdModel.nerd_model import MultiscaleNet as Net
...
# load yaml
with open(file="config.yaml", mode="r") as config:
...
for epoch in range(start_epoch, OPT['EPOCHS'] + 1):
    ...
    #     total_loss = char_l1_loss + ssim_loss + 0.01 * vgg_loss
    #
    #     loss = total_loss
    #

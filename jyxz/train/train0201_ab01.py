...
from Models.model0201_ab01 import Uformer
...
# load yaml
with open(file="../configs/config0201_ab01.yaml", mode="r") as config:
...
if TRAIN['RESUME']:
    path_chk_rest = utils.get_last_path(resume_path, '_bestSSIM_epoch.pth')

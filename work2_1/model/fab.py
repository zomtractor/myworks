...
from model import LayerNorm, CAB, ABTB, BasicConv
...
class FAB(nn.Module):  # Feature Attention Block
    def __init__(self, channels):
        ...
        self.ff = nn.Sequential(
            BasicConv(channels, channels // 4, 3, 1, norm=True, relu=True),
            BasicConv(channels // 4, channels, 3, 1, norm=True, relu=False)
        )
